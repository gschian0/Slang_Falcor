# sp08_autodiff — Automatic Differentiation

sumOfSquares field + |dF/dx| + |dF/dy| panels.
...
```powershell
python -m slang_falcon.live --lesson slang_playground/sp08_autodiff
